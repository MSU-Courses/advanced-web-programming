...
Теперь у нас есть форма с полями ввода. Как отправить данные на сервер?
...
Мы научились создавать форму и знаем, как она она отправляет данные на сервер. Теперь переходим к самому важному — приему и обработке данных на стороне сервера с помощью PHP.
