...
На предыдущих этапах мы рассматривали способы улучшения структуры HTML-кода с помощью подключения файлов (`header.php`, `footer.php`) и использования функций-компонентов. Эти подходы дают удобство и переиспользуемость, но они всё ещё не обеспечивают чёткого разделения логики и представления — PHP и HTML остаются тесно связаны.
...
### Рендеринг списков элементов и условных блоков
