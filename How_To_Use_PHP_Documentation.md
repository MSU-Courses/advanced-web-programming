...
Пользователь добавил пример распаковки двумерного массива с помощью `foreach` без использования вложенных циклов, данного примера нет в основном тексте документации. Это дополнение может быть полезным в реальных задачах.
