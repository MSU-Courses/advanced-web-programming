...
Пользователь добавил пример распаковки двумерного массива с помощью `foreach` без использования вложенных циклов, данного примера нет в основном тексте документации
