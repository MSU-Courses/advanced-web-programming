...
Для взаимодействия PHP с базой данных MySQL одно из базовых средств – расширение MySQLi (_MySQL Improved_). Рассмотрим шаги работы с базой данных через MySQLi в процедурном стиле.
