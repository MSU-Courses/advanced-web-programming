...
## Что хранить в куки, сессиях и базе данных?

Мы рассмотрели два механизма хранения данных состояния: _куки_ и _сессии_.

Возникает вопрос – какие данные где лучше хранить? Также в веб-приложениях есть и вариант хранения в базе данных. Каждый из этих вариантов имеет свои особенности:
